...
class HolderPostgresAdapter (
    ...
    override suspend fun create(holder: Holder): Optional<Holder> {
        try {
            ...
            throw GeneralException("Error creating holder with id ${holder.id} on database.")
        }
    }
    ...
    override suspend fun findByCpf(holderCpf: String): Optional<Holder> {
       try {
           ...
           throw GeneralException("Error getting holder with cpf $holderCpf on database.")
       }
    }
    ...
    override suspend fun delete(id: UUID) {
        try {
            ...
            throw GeneralException("Error creating holder with id $id on database.")
        }
    }
    ...
    override suspend fun getAll(): List<Holder> {
        try {
            ...
            throw GeneralException("Error getting all holders on database.")
        }
    }
}